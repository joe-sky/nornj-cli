      ...
      .then(answers => {
        co(function*() {
          const componentTemplate =
            answers.componentTemplate === 'default' ? '' : nj.filters.pascal(answers.componentTemplate);
          ...
          const componentFiles = fs.readdirSync(`./templates/src/web/components/newComponent${componentTemplate}`);
          componentFiles.forEach(fileName => {
            ...
            renderFile(
              `./templates/src/web/components/newComponent${componentTemplate}/${fileName}`,
              `./src/web/components/${componentName}/${
                isNewComponentFile ? nj.filters.pascal(componentName + newComponentExName) : fileName
              }`,
              { componentName }
            );
          });
