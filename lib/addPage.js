...
module.exports = () => {
  ...
  if (templateMultiPage) {
    ...
    inquirer.prompt([{
      ...
      choices: pkg.njCliConfig.pageTemplates ? pkg.njCliConfig.pageTemplates : [
        'default',
        'chart',
        'form',
        'empty',
      ...
      co(function* () {
        ...
        pageFiles.forEach(fileName => {
          const isNewPageFile = fileName.startsWith('newPage.'),
          ...
          renderFile(`./templates/src/web/pages/newPage${pageTemplate}/${fileName}`, `./src/web/pages/${pageName}/${isNewPageFile ? pageName + _newPageExName : fileName}`, { pageName });
        });

        //store files
        renderFile(`./templates/src/stores/pages/newPageStore${pageTemplate}.js`, `./src/stores/pages/${pageName}Store.js`, { pageName });
        ...
        renderFile(`./src/stores/rootStore.js`, null, {
          ...
          importStore: nj.render(tmplsRootStore.importStore, { pageName }),
          pageStore: nj.render(tmplsRootStore.pageStore, { pageName })
        });
        ...
        renderFile(`./routes-web.js`, null, {
          ...
          importLoadPage: nj.render(tmplsRoutesWeb.importLoadPage, { pageName, exName: newPageExName }),
          loadPage: nj.render(tmplsRoutesWeb.loadPage, { pageName }),
          pageComponent: nj.render(tmplsRoutesWeb.pageComponent, { pageName }),
          route: nj.render(tmplsRoutesWeb.route, { pageName }),
          clear: tmplsRoutesWeb.clearRegex ? new RegExp(tmplsRoutesWeb.clearRegex.trim(), 'g') : (pkg.njCliConfig.useJsx ? /\{\/\*__extraComment__\*\/\}/g : /<!--__extraComment__-->/g)
        });
