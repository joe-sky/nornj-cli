      ...
      .then(answers => {
        co(function*() {
          ...
          renderFile(`./routes-web.js`, null, {
            ...
            importLoadPage: nj.render(tmplsRoutesWeb.importLoadPage, {
              pageName,
              exName: newPageExName
            }),
            loadPage: nj.render(tmplsRoutesWeb.loadPage, { pageName }),
            pageComponent: nj.render(tmplsRoutesWeb.pageComponent, {
              pageName
            }),
            route: nj.render(tmplsRoutesWeb.route, { pageName }),
            clear: tmplsRoutesWeb.clearRegex
              ? new RegExp(tmplsRoutesWeb.clearRegex.trim(), 'g')
              : pkg.njCliConfig.useJsx
                ? /\{\/\*__extraComment__\*\/\}/g
                : /<!--__extraComment__-->/g
          });
