...
module.exports = () => {
  co(function*() {
    ...
    const templateType = require(`${process.cwd()}/package.json`).templateType;
    ...
    if (templateMultiPage) {
      ...
      //page resource files
      renderFile(`./templates/src/web/pages/newPage/newPage.js`, `./src/web/pages/${pageName}/${pageName}.js`, { pageName });
      renderFile(`./templates/src/web/pages/newPage/newPage.m.scss`, `./src/web/pages/${pageName}/${pageName}.m.scss`, { pageName });
      renderFile(`./templates/src/web/pages/newPage/newPage.t.html`, `./src/web/pages/${pageName}/${pageName}.t.html`, { pageName });

      //store files
      renderFile(`./templates/src/stores/pages/newPageStore.js`, `./src/stores/pages/${pageName}Store.js`, { pageName });
