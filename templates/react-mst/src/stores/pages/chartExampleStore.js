...
const ChartExampleStore = types
  ...
  .actions(self => ({
    getSummaryData() {
      return axios.get(`${__HOST}/chartExample/getSummaryData`)
        .then(self.setSummaryData)
        .catch((ex) => {
          Notification.error({ message: '获取Summary数据错误:' + ex, duration: null });
        });
    },
    setSummaryData({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取Summary数据异常:' + result.message, duration: null });
      }
    },
    getGrowthData(params) {
      return axios.get(`${__HOST}/chartExample/growthData`, {
        params
      })
        .then(self.setGrowthData)
        .catch((ex) => {
          Notification.error({ message: '获取Growth数据错误:' + ex, duration: null });
        });
    },
    setGrowthData({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取Growth数据异常:' + result.message, duration: null });
      }
    },
    getSubCategoryData(params) {
      return axios.get(`${__HOST}/chartExample/getSubCategoryData`, {
        params
      })
        .then(self.setSubCategoryData)
        .catch((ex) => {
          Notification.error({ message: '获取SubCategory数据错误:' + ex, duration: null });
        });
    },
    setSubCategoryData({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取SubCategory数据异常:' + result.message, duration: null });
        self.setShowSubCategoryBlock(false);
      }
    },
    getBarSubCategoryData(params) {
      return axios.get(`${__HOST}/chartExample/getBarSubCategoryData`, {
        params
      })
        .then(self.setBarSubCategoryData)
        .catch((ex) => {
          Notification.error({ message: '获取BarSubCategory数据错误:' + ex, duration: null });
        });
    },
    setBarSubCategoryData({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取BarSubCategory数据异常:' + result.message, duration: null });
      }
    },
    getTableSubCategoryData(params) {
      return axios.get(`${__HOST}/chartExample/getTableSubCategoryData`, {
        params
      })
        .then(self.setTableSubCategoryData)
        .catch((ex) => {
          Notification.error({ message: '获取TableSubCategory数据错误:' + ex, duration: null });
        });
    },
    setTableSubCategoryData({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取TableSubCategory数据异常:' + result.message, duration: null });
      }
    },
    getBrandCompareList(params) {
      return axios.get(`${__HOST}/chartExample/getBrandCompareList`, {
        params
      })
        .then(self.setBrandCompareList)
        .catch((ex) => {
          Notification.error({ message: '获取BrandCompare数据错误:' + ex, duration: null });
        });
    },
    setBrandCompareList({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取BrandCompare数据异常:' + result.message, duration: null });
      }
    },
    ...
    getBrandCompareItemForCategory(params) {
      return axios.get(`${__HOST}/chartExample/getBrandCompareItemForCategory`, {
        params
      })
        .then(self.setBrandCompareItemForCategory)
        .catch((ex) => {
          Notification.error({ message: '获取BrandCompareItemForCategory数据错误:' + ex, duration: null });
        });
    },
    setBrandCompareItemForCategory({ data: result }) {
      if (result.success) {
        ...
        Notification.error({ message: '获取BrandCompareItemForCategory数据异常:' + result.message, duration: null });
      }
    },
