...
export default class ModalFormPage extends Component {
  ...
  getDefaultCheckedKeys() {
    let keys = [];
    this.props.store.defaultExample.menuData
      .filter(n => n.level == 3)
      .forEach(item => {
        if (item.selected) {
  ...
  render() {
    ...
    return (
      <Modal
        width={500}
        visible={this.props.tabName == '增加角色' ? defaultExample.addModalVisible : defaultExample.editModalVisible}
        footer={null}
        ...
        <Tabs activeKey={defaultExample.activeKey} onChange={this.onTabChange}>
          <Tabs.TabPane tab="增加角色" key="tab1">
            <ul className="frombox">
              <li>
                角色名称 <span className="red"></span>
              </li>
              <li>
                <Input onChange={this.onAddInputRoleChange} value={defaultExample.addInputRole} />
              </li>
              <li>角色描述</li>
              <li>
                <Input.TextArea
                  ...
                  className="textarea"
                  value={defaultExample.addInputDes}
                />
              </li>
          ...
          <Tabs.TabPane
            tab="配置权限"
            key="tab2"
            disabled={this.props.tabName == '增加角色' ? defaultExample.isDisable : null}>
            ...
            <div className={styles.btnArea}>
              <Button
                ...
                disabled={this.props.tabName == '编辑角色' ? defaultExample.saveBtnDisabled : null}>
                保存
              </Button>
              <Button className="btn" onClick={this.onAddCancel}>
                取消
