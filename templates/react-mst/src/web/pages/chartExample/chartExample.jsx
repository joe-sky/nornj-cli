...
export default class ChartExample extends Component {
  ...
  onSearch = async () => {
    ...
    await Promise.all([
      this.props.store.chartExample.getSummaryData(),
      this.props.store.chartExample.getGrowthData(),
      this.props.store.chartExample.getSubCategoryData(),
      this.props.store.chartExample.getBarSubCategoryData(),
      this.props.store.chartExample.getTableSubCategoryData(),
      this.props.store.chartExample.getBrandCompareList(),
      this.props.store.chartExample.getBrandCompareItemForCategory()
    ]);
      ...
      <Row className={styles.summary}>
        <Col span={6}>
          <div className={styles.summaryItem}>
            ...
            <div className={styles.num}>{(chartExample.summaryData.gmv / 10000).toFixed(2)}万元</div>
        ...
        <Col span={6}>
          <div className={styles.summaryItem}>
            ...
            <div className={styles.num}>{chartExample.summaryData.uv}</div>
            <div className={`${styles.rates} clearfix`}>
        ...
        <Col span={6}>
          <div className={styles.summaryItem}>
            ...
            <div className={styles.num}>{chartExample.summaryData.uvRates}%</div>
            <div className={`${styles.rates} clearfix`}>
        ...
        <Col span={6}>
          <div className={styles.summaryItem}>
            ...
            <div className={styles.num}>{chartExample.summaryData.userCount}</div>
            <div className={`${styles.rates} clearfix`}>
                ...
                <tbody>
                  <Each of={chartExample.tableSubCategoryData}>
                    <tr key={index}>
                      ...
                      <td>{n`(${item}.salesGrowthRates * 100).toFixed(2)`}%</td>
                      <td>{n`(${item}.uvGrowth * 100).toFixed(2)`}%</td>
                      <td>{n`(${item}.uvConvert * 100).toFixed(2)`}%</td>
                      <td>{n`${item}.price.toFixed(2)`}</td>
                      <td>{n`(${item}.userGrowth * 100).toFixed(2)`}%</td>
                      <td>{n`(${item}.salesRates1 * 100).toFixed(2)`}%</td>
                      <td>{n`(${item}.salesGrowthRates1 * 100).toFixed(2)`}%</td>
                      <td>{n`(${item}.uvGrowth1 * 100).toFixed(2)`}%</td>
                      <td>{n`(${item}.uvConvert1 * 100).toFixed(2)`}%</td>
                      <td>{n`${item}.price1.toFixed(2)`}</td>
                      <td>{n`(${item}.userGrowth1 * 100).toFixed(2)`}%</td>
                    </tr>
                  </Each>
                </tbody>
              </table>
...
class BrandCompare extends Component {
    ...
    return (e) => {
      if (e.target.checked) {
        ...
        if (this.props.store.chartExample.compareDockData) {
          if (this.props.store.chartExample.compareDockData.length + 1 < 5) {
  ...
  closeCompareTable = () => {
    this.props.store.chartExample.setShowCompareTable(false);
    this.props.store.chartExample.clearCompareDockData();
  };
...
class CompareDock extends Component {
  ...
  closeCompareDock = () => {
    this.props.store.chartExample.setCompareDockVisible(false);
  };

  compareIt = () => {
    this.props.store.chartExample.setShowCompareTable(true);
    this.props.store.chartExample.setCompareDockVisible(false);
  };
