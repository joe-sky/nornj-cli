  ...
  render() {
    ...
    return (
      <div className={styles.#{pageName}#}>
        ...
        <ElForm model={#{pageName}#.formModel} rules={this.rules} ref="form" labelWidth="100">
          <ElForm.Item label="表单元素1" prop="formEl1">
            <ElInput value={#{pageName}#.elInputValue} onChange={value => #{pageName}#.setElInputValue(value)} />
          </ElForm.Item>
          <ElForm.Item label="表单元素2" prop="formEl2">
            <ElSelect placeholder="请选择" value={#{pageName}#.elSelectValue} onChange={value => #{pageName}#.setElSelectValue(value)}>
          ...
          <ElForm.Item label="表单元素3" prop="formEl3">
            <ElRadio.Group value={#{pageName}#.elRadioValue} onChange={value => #{pageName}#.setElRadioValue(value)}>
          ...
          <ElForm.Item label="表单元素4" prop="formEl4">
            <ElCheckbox.Group value={#{pageName}#.elCheckboxValue} onChange={value => #{pageName}#.setElCheckboxValue(value)}>
          ...
          <ElForm.Item label="表单元素5" prop="formEl5">
            <ElDatePicker placeholder="选择日期" value={#{pageName}#.elDate} onChange={value => #{pageName}#.setElDate(value)} />
          </ElForm.Item>
        </ElForm>
        <div className={styles.btnArea}>
