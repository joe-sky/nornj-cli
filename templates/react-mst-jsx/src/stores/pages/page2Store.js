  ...
  .actions(self => {
    return {
      ...
      getRoleMenuTree(params) {
        return fetchData(`${__HOST}/page2/getRoleMenuTree`,
      ...
      getRoleManagementData(params) {
        return fetchData(`${__HOST}/page2/getRoleManagementData`,
      ...
      searchRole(params) {
        return fetchData(`${__HOST}/page2/searchRole`,
          self.setSearchRole,
          params, { method: 'get' }).catch((ex) => {
          Notification.error({
      ...
      saveRole(params) {
        return fetchData(`${__HOST}/page2/saveRole`,
          self.setSaveRole,
      ...
      saveRolePermission(params) {
        return fetchData(`${__HOST}/page2/saveRolePermission`,
      ...
      deleteRole(params) {
        return fetchData(`${__HOST}/page2/deleteRole`,
          self.setDeleteRole,
          params, { method: 'post' }).catch((ex) => {
          Notification.error({
